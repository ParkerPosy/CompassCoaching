...
export default function Header() {
  ...
  const assessmentSections = [
    { id: 'basic', label: 'Basic Information', icon: User, path: '/intake/basic', completed: progress.basic },
    { id: 'personality', label: 'Personality', icon: Brain, path: '/intake/personality', completed: progress.personality },
    { id: 'values', label: 'Values', icon: Heart, path: '/intake/values', completed: progress.values },
    { id: 'aptitude', label: 'Career Aptitude', icon: Target, path: '/intake/aptitude', completed: progress.aptitude },
    { id: 'challenges', label: 'Challenges', icon: AlertCircle, path: '/intake/challenges', completed: progress.challenges },
  ]
    ...
    <>
      <header className="p-4 flex items-center justify-between bg-white border-b border-stone-200 sticky top-0 z-50 shadow-sm">
        ...
        <Link
          ...
          activeProps={{
            className: 'px-4 py-2 rounded-lg bg-lime-100 text-lime-700 transition-colors font-medium flex items-center gap-2',
          }}
        >
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          ...
          <div className="border-t border-stone-200 pt-4">
            ...
            >
              ...
              {showAssessmentMenu ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
            </button>
