...
export const Route = createFileRoute('/resources/career-transitions')({
  component: CareerTransitionsPage,
})

function CareerTransitionsPage() {
  const resources = [
    {
    ...
    },
    {
      ...
      type: 'Worksheet',
      duration: '15 min',
      description: 'Identify skills that transfer to new careers',
    },
    {
      title: 'Industry Switcher Stories',
      type: 'Article',
      duration: '20 min',
      description: 'Real examples of successful career pivots',
    },
    {
      title: 'Gap Year Planning Guide',
      type: 'Guide',
      duration: '25 min',
      description: 'Make the most of career breaks',
    },
    {
      title: 'Return to Work Guide',
      type: 'Guide',
      duration: '30 min',
      description: 'Re-enter the workforce after a break',
    },
    {
      title: 'Entrepreneurship Starter',
      type: 'Resource',
      duration: '40 min',
      description: 'Start your own business basics',
    },
  ]
        ...
        <Container size="sm">
          <div className="text-center">
            ...
            <p className="text-xl text-stone-600">
              Navigate career changes and pivots successfully
            </p>
          </div>
        </Container>
      </section>
