...
export const Route = createFileRoute('/contact')({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Have questions about career coaching or our free resources? Contact Compass Coaching for guidance and support. We\'re here to help you navigate your future.',
      },
    ],
  }),
})
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-stone-700">
              Have questions about Compass Coaching? We're here to help guide you on your journey.
            </p>
          </div>
        </Container>
      </section>
