...
function ChallengesPage() {
  ...
  const handleCheckboxChange = (field: keyof ChallengesData, value: string, checked: boolean) => {
  ...
  const requiredFields = ['financial', 'timeAvailability', 'locationFlexibility', 'supportSystem']
  const filledRequired = requiredFields.filter((field) => formData[field as keyof ChallengesData])
      ...
      <Container size="sm">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-stone-600">Section 5 of 5</span>
            <span className="text-sm font-medium text-lime-700">Final Section!</span>
          </div>
          <div className="w-full h-2 bg-stone-200 rounded-full overflow-hidden">
            <div className="h-full bg-lime-600 transition-all duration-500" style={{ width: '90%' }} />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="text-2xl">Challenges & Constraints</CardTitle>
              <p className="text-stone-600 mt-2">
                Understanding your constraints helps us provide realistic recommendations. All information is
                confidential.
              </p>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              {/* Financial Situation */}
              <div>
                <label htmlFor="financial" className="block text-sm font-medium text-stone-700 mb-2">
                  What's your current financial situation for education/training?{' '}
                ...
                >
                  ...
                  <option value="no-constraints">No major financial constraints</option>
                  <option value="some-savings">Some savings available</option>
                  <option value="need-financial-aid">Will need financial aid/loans</option>
                  <option value="limited-funds">Very limited funds available</option>
                  <option value="working-while-learning">Must work while learning</option>
                </select>
              </div>

              {/* Time Availability */}
              <div>
                <label htmlFor="timeAvailability" className="block text-sm font-medium text-stone-700 mb-2">
                ...
                >
                  ...
                  <option value="very-limited">Very limited (under 10 hours/week)</option>
              ...
              <div>
                ...
                >
                  Are you able to relocate for work or education? <span className="text-error-500">*</span>
                </label>
                <select
                ...
                >
                  <option value="">Select option</option>
                  <option value="yes-anywhere">Yes, willing to relocate anywhere</option>
                  <option value="same-region">Yes, within same region/state</option>
                  <option value="local-only">Must stay in current area</option>
                  <option value="remote-preferred">Prefer remote opportunities</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleChange('familyObligations', e.target.value)}
                  className="w-full px-4 py-3 border-2 border-stone-200 rounded-lg focus:border-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600/20 transition-all bg-white"
                >
                  <option value="">Select option</option>
                  <option value="none">No significant obligations</option>
                  <option value="childcare">Childcare responsibilities</option>
                  <option value="elder-care">Elder care responsibilities</option>
              ...
              {/* Transportation */}
              <div>
                <label htmlFor="transportation" className="block text-sm font-medium text-stone-700 mb-2">
                ...
                >
                  ...
                  <option value="public-transit">Rely on public transportation</option>
                  <option value="limited">Limited transportation options</option>
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-stone-700 mb-2"
                >
                  Are there any health considerations that might affect career choices?
                </label>
                <select
                  id="healthConsiderations"
                  value={formData.healthConsiderations}
                  onChange={(e) => handleChange('healthConsiderations', e.target.value)}
                  className="w-full px-4 py-3 border-2 border-stone-200 rounded-lg focus:border-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600/20 transition-all bg-white"
                >
                  <option value="">Select option</option>
                  <option value="none">No limitations</option>
                  <option value="physical">Physical limitations</option>
                  <option value="mental-health">Mental health considerations</option>
                  <option value="chronic-condition">Chronic health condition</option>
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-3">
                  Which areas might you need additional preparation in? (Select all that apply)
                </label>
                <div className="space-y-2">
                  {[
                    ...
                    <label key={gap} className="flex items-center gap-3 p-3 rounded-lg hover:bg-stone-50">
                      <input
                        type="checkbox"
                        checked={formData.educationGaps.includes(gap)}
                        onChange={(e) => handleCheckboxChange('educationGaps', gap, e.target.checked)}
              ...
              {/* Support System */}
              <div>
                <label htmlFor="supportSystem" className="block text-sm font-medium text-stone-700 mb-2">
                  How would you describe your support system? <span className="text-error-500">*</span>
                </label>
                <select
                  id="supportSystem"
              ...
              {/* Additional Notes */}
              <div>
                <label htmlFor="additionalNotes" className="block text-sm font-medium text-stone-700 mb-2">
          ...
          <div className="mb-6 p-6 bg-lime-50 border-2 border-lime-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-lime-900 mb-1">Almost done!</h3>
                <p className="text-lime-800">
                  You're on the final section. After submitting, you'll be able to review all your answers
                  before getting your personalized results.
                </p>
              </div>
            </div>
          </div>
