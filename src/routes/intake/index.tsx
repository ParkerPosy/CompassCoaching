...
export const Route = createFileRoute('/intake/')({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Take our comprehensive 5-section career assessment covering personality, values, aptitudes, and challenges. Get personalized career recommendations and guidance. 100% free.',
      },
    ],
  }),
})
...
function IntakePage() {
  const sections = [
    ...
    },
    {
      ...
      description: 'Discover your work environment and collaboration preferences',
      duration: '5 minutes',
      questions: 8,
    },
    {
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-stone-600 max-w-2xl mx-auto">
              Our comprehensive assessment covers five key areas to help us understand you better.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <Card variant="outlined" className="bg-lime-50 border-lime-300">
              <CardHeader>
                <div className="w-12 h-12 bg-lime-400 rounded-lg flex items-center justify-center mb-4 text-stone-900">
        ...
        <Container size="sm">
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-lime-400 rounded-full flex items-center justify-center shrink-0 text-stone-900 font-semibold">
                1
              </div>
              <div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-stone-600">
                  Create a free account to save your answers and resume later if needed.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-stone-600">
                  Receive personalized career matches, resource recommendations, and next steps.
                </p>
              </div>
            </div>
          </div>
