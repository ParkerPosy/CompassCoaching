      ...
      <Container size="sm">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-stone-600">Section 3 of 5</span>
            <span className="text-sm font-medium text-stone-600">60% Complete</span>
          </div>
          <div className="w-full h-2 bg-stone-200 rounded-full overflow-hidden">
            <div className="h-full bg-lime-600 transition-all duration-500" style={{ width: '60%' }} />
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card className="mb-6">
            <CardHeader>
              ...
              <p className="text-stone-600 mt-2">
                Rate how important each value is to you in your ideal career. Be honest - there are no right
                answers!
              </p>
              <div className="mt-4 flex items-center gap-2 text-sm">
                <span className="text-stone-500">Scale:</span>
                <span className="text-stone-700 font-medium">1 = Not Important</span>
                <span className="text-stone-400">→</span>
                <span className="text-stone-700 font-medium">5 = Extremely Important</span>
              </div>
            </CardHeader>

            <CardContent className="space-y-6">
              {values.map((value) => (
                <div key={value.id} className="pb-6 border-b border-stone-200 last:border-0 last:pb-0">
                  <div className="mb-3">
                    <h3 className="text-lg font-semibold text-stone-900">{value.label}</h3>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-stone-600">Section Progress</span>
              <span className="text-sm font-medium text-lime-700">{Math.round(progress)}%</span>
            </div>
            <div className="w-full h-2 bg-stone-200 rounded-full overflow-hidden">
              <div
